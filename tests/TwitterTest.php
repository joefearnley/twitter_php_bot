 ...
 * @date 01/21/2010
 * 
 * I modified the Twitter class by adding some additional functions. 
 * These are the units tests for those functions. The functions names 
 * reflect which functions of the Twitter class they test.
 */
